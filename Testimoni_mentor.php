...
<body data-spy="scroll" data-target="#navbar" class="static-layout">
    ...
    <div class="container">
        <a class="navbar-brand d-flex align-items-center text-white" href="index_mentor.php">
            <h2 class="font-weight-bolder mb-0">CESSGO</h2>
        </a>
        <a class="navbar-brand d-flex align-items-center text-white" href="index_mentor.php">
            <h5 class="font-weight-bolder mb-0">Home</h5>
        </a>
        <a class="navbar-brand d-flex align-items-center text-white" href="program_mentor.php">
            <h5 class="font-weight-bolder mb-0">Program</h5>
        </a>
        <a class="navbar-brand d-flex align-items-center text-white" href="Testimoni_mentor.php">
            <h5 class="font-weight-bolder mb-0">Testimoni</h5>
        </a>
        <a class="navbar-brand d-flex align-items-center text-white" href="data_pembayaran_mentor.php">
            <h5 class="font-weight-bolder mb-0">Data pembayaran</h5>
        </a>
...
<div class="jumbotron jumbotron-single d-flex align-items-center" style="background-image: url(img/bg2.jpg)">
...
<footer class="mastfoot my-3">
    <div class="inner container">
         <div class="row">
         	...
         	<div class="col-lg-4 col-md-12 d-flex align-items-center">
         		<p class="mx-auto text-center mb-0">  2022 Politeknik Negeri Sriwijaya. Design by Toriq&Anissa</a>.</p>
         	</div>
